...
<html>
	<head>
		...
		<title>Scholarship Entrance Test | IAS</title>
...
<body>
	...
	<div class="container-fluid admission-banner">
		<h2>SCHOLARSHIP ENTRANCE TEST (SET)</h2>
	...
	<div class="container content">
		...
		<div class="row">
			...
			<div class="col-sm-8 ">
				<p class="title">Scholarship Entrance Test (SET)</p>
				...
				<div id="accordion" class="panel-group">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">
								<a href="#panelbody3" data-toggle="collapse" data-parent="#accordion"><span class="glyphicon glyphicon-minus-sign picon"></span>Scholarship Entrance Test (SET)</a>
							</h4>
						</div>
