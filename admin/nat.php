		...
		<div class="modal-dialog">
			<div class="modal-content" >
				...
				<div class="modal-body">
					...
					<input type="text" class="form-control" name="nat_ans" id="ans" placeholder="Correct Answer">  
		...
		<div class="row display-table-row">
			...
			<div class="col-md-10 col-sm-11 display-table-cell valign-top">
				...
				<div id="content">				
					...
					<p class="dir" style="padding:0 0px 0 20px; margin-bottom: -5px;">Question Type: <b>NAT</b></p>
					...
					<div class="content-inner">
						...
						<p id="search_res"><span id="no">5</span> results found on "<span id="string">sss</span>"</p>
							...
							<?php
								...
								if(mysqli_num_rows($res) > 0){
									while($nat = mysqli_fetch_array($res)){
										echo '
											<div class="stu-con">
												<div class="statement" id="stmt'.$nat['nat_id'].'">'.$nat['nat_statement'].'</div><br>
												<b><div>Answer: </b><span class="answer" id="ans'.$nat['nat_id'].'">'.$nat['nat_answer'].'</span></div><br>
