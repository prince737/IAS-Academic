			...
			<div class="col-md-10 col-sm-11 display-table-cell valign-top">
				...
				<div id="content">				
					<header class="clearfix">
						<h2 class="page_title pull-left">Create a new paper</h2>	
						<a type="button" class="new pull-right btn-primary btn-xs" href="papers.php">View all Papers</a>
					</header>
			...
			echo '			    
			    <div id="success-modal">
					<div class="modalconent">
						<h3 style="color:teal;">Information</h3>
						<hr>	
						<p class="para">Question Paper was successfully added. Its Id is  <b>'.$_GET['id'].'</b>.<br> Go to <a href="papers.php">view all</a> page to start adding questions to it.</p> 
						<button id="button" class="btn btn-danger btn-sm pull-right">Close</button>
					</div>
				</div>
			';	
