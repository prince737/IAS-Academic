						...
						<div class="form-wrapper">
							<form action="includes/notices.inc.php" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="body" placeholder="Body (This will be displayed on Notice Board) " required ></textarea>
								</div>
								<div class="form-group">
									<p for="doc">Document for the notice in pdf or doc Format: </p>
	...
	<script>
		window.onload = function () {
			document.getElementById('button').onclick = function () {
				...
				window.location.replace('admin_notices.php');
			};
		};
	</script>
